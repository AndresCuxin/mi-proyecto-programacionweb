...
async function cargarTabla(q="") {
  ...
  (j.items || []).forEach(c => {
    ...
    tr.innerHTML = `
      <td style="padding:6px; border-bottom:1px solid #1f2937;">${c.id}</td>
      <td style="padding:6px; border-bottom:1px solid #1f2937;">${c.nombre || ""}</td>
      <td style="padding:6px; border-bottom:1px solid #1f2937;">${c.telefono || ""}</td>
      <td style="padding:6px; border-bottom:1px solid #1f2937;">${c.email || ""}</td>
      <td style="padding:6px; border-bottom:1px solid #1f2937;">
        <button data-editar="${c.id}">Editar</button>
        <button data-borrar="${c.id}">Borrar</button>
      </td>`;
